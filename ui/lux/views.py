...
def question(request, question_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if len(content) > 20:
                num_features = 300
                model = word2vec.KeyedVectors.load_word2vec_format(os.path.join(current_path, "ai_files/word2vecmodel.bin"), binary=True)
                clean_test_essays = []
                ...
                lstm_model.load_weights(os.path.join(current_path, "ai_files/final_lstm.h5"))
